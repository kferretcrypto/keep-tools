...
const ComparisonTHORChainTHORNode = () => (
  <React.Fragment>
    <H1>THORChain THORNode Comparison Guide</H1>
    ...
    <P>
      This guide is designed for those already familiar with running a THORChain THORNode to learn more about running a Keep node, or for anyone who wishes to compare and contrast the two. Therefore, it assumes that you are fairly technical. As with all cryptocurrency and blockchain technologies, things can change fairly quickly so please make sure that the version of this page you are reading has been updated in the past few months.
    </P>
    <br />
...
const P = styled.p`
  margin-top: 0;
`
export default ComparisonTHORChainTHORNode
